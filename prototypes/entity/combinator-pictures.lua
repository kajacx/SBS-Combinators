function generate_arithmetic_combinator(combinator)
  combinator.sprites =
    make_4way_animation_from_spritesheet({ layers =
      {
        {
          filename = "__SBS-Combinators__/graphics/entity/combinator/arithmetic-combinator.png",
          width = 74,
          height = 64,
          frame_count = 1,
          ...
          {
            scale = 0.5,
            filename = "__SBS-Combinators__/graphics/entity/combinator/hr-arithmetic-combinator.png",
            width = 144,
            height = 124,
            frame_count = 1,
...
function generate_decider_combinator(combinator)
  combinator.sprites =
    make_4way_animation_from_spritesheet({ layers =
      {
        {
          filename = "__SBS-Combinators__/graphics/entity/combinator/decider-combinator.png",
          width = 78,
          height = 66,
          frame_count = 1,
          ...
          {
            scale = 0.5,
            filename = "__SBS-Combinators__/graphics/entity/combinator/hr-decider-combinator.png",
            width = 156,
            height = 132,
            frame_count = 1,
            shift = util.by_pixel(0.5, 7.5)
...
function generate_constant_combinator(combinator)
  combinator.sprites =
    make_4way_animation_from_spritesheet({ layers =
      {
        {
          filename = "__SBS-Combinators__/graphics/entity/combinator/constant-combinator.png",
          width = 58,
          height = 52,
          frame_count = 1,
          ...
          {
            scale = 0.5,
            filename = "__SBS-Combinators__/graphics/entity/combinator/hr-constant-combinator.png",
            width = 114,
            height = 102,
            frame_count = 1,
            shift = util.by_pixel(0, 5)
